...
dict = {"C++": "Back-End Developer", "Python" : "Machine Learning",
        "Swift": "IOS Developer", "Java": "Full-Stack Developer",
        "HTML": "Web Developer", "CSS": "UI/UX", "JavaScript": "Web Developer",
        "Git": "Program Manager", "Conflict Resolution": "Counselor", "Organization": "Teacher", 
        "Communication": "Therapist"}

def skills_to_profession(skills):
    professions = []
    for skill in skills:
        if skill in dict:
            professions.append(dict.get(skill))
    return professions

def professions_to_jobs(professions):
    find_jobs_from('Indeed', professions[0], 'Texas', ['titles', 'companies', 'links', 'date_listed'], filename="results.xls")